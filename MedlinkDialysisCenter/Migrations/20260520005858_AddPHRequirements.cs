...
{
    /// <inheritdoc />
    public partial class AddPHRequirements : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PHRequirements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PHRequirements_Patients_PatientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PHRequirements_PatientId",
